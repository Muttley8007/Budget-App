    ...
    return `
      <div class="card">
        ...
        <div class="card-actions">
          ...
          <button class="btn btn-secondary btn-icon" onclick="editPay('${p.id}')" title="Edit">✏</button>
          <button class="btn btn-secondary" onclick="closePay('${p.id}')">Close</button>
          <button class="btn btn-danger btn-icon" onclick="delPay('${p.id}')" title="Delete">✕</button>
        </div>
